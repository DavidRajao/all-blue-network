...
<html lang="fr">
  <head>
    ...
    <title>Visionner le manga | All Blue Network</title>
  ...
  <body onload="genererGuide(1)">
    ...
    <main>
      ...
      <section class="content">
        <h1>Visionner le manga</h1>
        <h3>Voici une liste des plateformes pour visionner le manga de One Piece :</h3>
        <br>
        <div class="ctn-guide">
